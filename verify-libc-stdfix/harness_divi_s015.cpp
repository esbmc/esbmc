// Split from harness_divi_widths.cpp: that harness instantiated divi at TWO
// formats, which triggers esbmc/esbmc#6969 (only the first instantiation of a
// template containing a named lambda gets an operator() body; later ones return
// nondet). One instantiation per file makes the bug unreachable.

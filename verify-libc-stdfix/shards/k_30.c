/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 30/32.
...
{
  int xb = nondet_raw();
  /* Shard 30 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1879048192 && xb <= 2013265919);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 29/32.
...
{
  int xb = nondet_raw();
  /* Shard 29 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1744830464 && xb <= 1879048191);
  _Accum x;

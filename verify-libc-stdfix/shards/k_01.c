/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 1/32.
...
{
  int xb = nondet_raw();
  /* Shard 1 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -2013265920 && xb <= -1879048193);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 10/32.
...
{
  int xb = nondet_raw();
  /* Shard 10 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -805306368 && xb <= -671088641);
  _Accum x;

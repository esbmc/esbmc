/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 6/32.
...
{
  int xb = nondet_raw();
  /* Shard 6 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -1342177280 && xb <= -1207959553);
  _Accum x;

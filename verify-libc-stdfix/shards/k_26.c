/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 26/32.
...
{
  int xb = nondet_raw();
  /* Shard 26 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1342177280 && xb <= 1476395007);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 21/32.
...
{
  int xb = nondet_raw();
  /* Shard 21 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 671088640 && xb <= 805306367);
  _Accum x;

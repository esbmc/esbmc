/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 7/32.
...
{
  int xb = nondet_raw();
  /* Shard 7 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -1207959552 && xb <= -1073741825);
  _Accum x;

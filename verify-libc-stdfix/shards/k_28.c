/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 28/32.
...
{
  int xb = nondet_raw();
  /* Shard 28 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1610612736 && xb <= 1744830463);
  _Accum x;

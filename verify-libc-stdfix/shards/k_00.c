/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 0/32.
...
{
  int xb = nondet_raw();
  /* Shard 0 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -2147483648 && xb <= -2013265921);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 11/32.
...
{
  int xb = nondet_raw();
  /* Shard 11 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -671088640 && xb <= -536870913);
  _Accum x;

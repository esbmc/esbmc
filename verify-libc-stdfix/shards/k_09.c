/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 9/32.
...
{
  int xb = nondet_raw();
  /* Shard 9 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -939524096 && xb <= -805306369);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 18/32.
...
{
  int xb = nondet_raw();
  /* Shard 18 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 268435456 && xb <= 402653183);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 24/32.
...
{
  int xb = nondet_raw();
  /* Shard 24 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1073741824 && xb <= 1207959551);
  _Accum x;

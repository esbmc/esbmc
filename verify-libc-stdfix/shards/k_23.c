/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 23/32.
...
{
  int xb = nondet_raw();
  /* Shard 23 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 939524096 && xb <= 1073741823);
  _Accum x;

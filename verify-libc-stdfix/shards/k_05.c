/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 5/32.
...
{
  int xb = nondet_raw();
  /* Shard 5 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -1476395008 && xb <= -1342177281);
  _Accum x;

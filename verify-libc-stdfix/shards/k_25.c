/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 25/32.
...
{
  int xb = nondet_raw();
  /* Shard 25 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 1207959552 && xb <= 1342177279);
  _Accum x;

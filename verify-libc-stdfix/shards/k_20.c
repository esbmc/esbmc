/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 20/32.
...
{
  int xb = nondet_raw();
  /* Shard 20 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 536870912 && xb <= 671088639);
  _Accum x;

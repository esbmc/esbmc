/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 14/32.
...
{
  int xb = nondet_raw();
  /* Shard 14 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -268435456 && xb <= -134217729);
  _Accum x;

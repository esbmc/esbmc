/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 12/32.
...
{
  int xb = nondet_raw();
  /* Shard 12 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -536870912 && xb <= -402653185);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 8/32.
...
{
  int xb = nondet_raw();
  /* Shard 8 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -1073741824 && xb <= -939524097);
  _Accum x;

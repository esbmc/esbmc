/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 13/32.
...
{
  int xb = nondet_raw();
  /* Shard 13 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -402653184 && xb <= -268435457);
  _Accum x;

/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 2/32.
...
{
  int xb = nondet_raw();
  /* Shard 2 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= -1879048192 && xb <= -1744830465);
  _Accum x;

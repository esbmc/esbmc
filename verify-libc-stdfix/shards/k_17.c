/* Validate mkFXPSqrt at _Accum (s16.15) -- SHARD 17/32.
...
{
  int xb = nondet_raw();
  /* Shard 17 of 32: a disjoint slice of the int32 domain. The 32 shards
  ...
  __ESBMC_assume(xb >= 134217728 && xb <= 268435455);
  _Accum x;

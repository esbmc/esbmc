// exphk (s8.7) vs camada's mkFXPExp -- SHARD 27/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 22528 && xb <= 24575);   /* shard 27 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 27: agrees with the exact exp");
  return 0;
}

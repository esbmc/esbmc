// expk (s16.15) vs camada's mkFXPExp -- SHARD 17/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 134217728 && xb <= 268435455);   /* shard 17 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 17: agrees with the exact exp");
  return 0;
}

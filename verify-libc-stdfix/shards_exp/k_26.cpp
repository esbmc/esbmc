// expk (s16.15) vs camada's mkFXPExp -- SHARD 26/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1342177280 && xb <= 1476395007);   /* shard 26 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 26: agrees with the exact exp");
  return 0;
}

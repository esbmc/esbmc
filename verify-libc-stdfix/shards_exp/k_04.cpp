// expk (s16.15) vs camada's mkFXPExp -- SHARD 4/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1610612736 && xb <= -1476395009);   /* shard 4 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 4: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 18/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 268435456 && xb <= 402653183);   /* shard 18 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 18: agrees with the exact exp");
  return 0;
}

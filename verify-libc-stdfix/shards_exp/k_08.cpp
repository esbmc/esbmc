// expk (s16.15) vs camada's mkFXPExp -- SHARD 8/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1073741824 && xb <= -939524097);   /* shard 8 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 8: agrees with the exact exp");
  return 0;
}

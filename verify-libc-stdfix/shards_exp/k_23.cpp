// expk (s16.15) vs camada's mkFXPExp -- SHARD 23/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 939524096 && xb <= 1073741823);   /* shard 23 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 23: agrees with the exact exp");
  return 0;
}

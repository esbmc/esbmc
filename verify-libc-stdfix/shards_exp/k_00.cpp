// expk (s16.15) vs camada's mkFXPExp -- SHARD 0/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -2147483648 && xb <= -2013265921);   /* shard 0 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 0: agrees with the exact exp");
  return 0;
}

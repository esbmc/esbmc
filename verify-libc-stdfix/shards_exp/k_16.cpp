// expk (s16.15) vs camada's mkFXPExp -- SHARD 16/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 0 && xb <= 134217727);   /* shard 16 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 16: agrees with the exact exp");
  return 0;
}

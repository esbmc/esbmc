// exphk (s8.7) vs camada's mkFXPExp -- SHARD 21/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 10240 && xb <= 12287);   /* shard 21 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 21: agrees with the exact exp");
  return 0;
}

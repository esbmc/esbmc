// exphk (s8.7) vs camada's mkFXPExp -- SHARD 26/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 20480 && xb <= 22527);   /* shard 26 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 26: agrees with the exact exp");
  return 0;
}

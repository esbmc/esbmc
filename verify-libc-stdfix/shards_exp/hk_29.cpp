// exphk (s8.7) vs camada's mkFXPExp -- SHARD 29/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 26624 && xb <= 28671);   /* shard 29 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 29: agrees with the exact exp");
  return 0;
}

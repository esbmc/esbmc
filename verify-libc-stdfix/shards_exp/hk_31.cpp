// exphk (s8.7) vs camada's mkFXPExp -- SHARD 31/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 30720 && xb <= 32767);   /* shard 31 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 31: agrees with the exact exp");
  return 0;
}

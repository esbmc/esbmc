// expk (s16.15) vs camada's mkFXPExp -- SHARD 13/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -402653184 && xb <= -268435457);   /* shard 13 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 13: agrees with the exact exp");
  return 0;
}

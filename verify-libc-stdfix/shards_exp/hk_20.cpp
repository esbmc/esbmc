// exphk (s8.7) vs camada's mkFXPExp -- SHARD 20/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 8192 && xb <= 10239);   /* shard 20 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 20: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 12/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -536870912 && xb <= -402653185);   /* shard 12 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 12: agrees with the exact exp");
  return 0;
}

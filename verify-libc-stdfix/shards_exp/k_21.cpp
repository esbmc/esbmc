// expk (s16.15) vs camada's mkFXPExp -- SHARD 21/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 671088640 && xb <= 805306367);   /* shard 21 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 21: agrees with the exact exp");
  return 0;
}

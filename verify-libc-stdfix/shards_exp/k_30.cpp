// expk (s16.15) vs camada's mkFXPExp -- SHARD 30/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1879048192 && xb <= 2013265919);   /* shard 30 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 30: agrees with the exact exp");
  return 0;
}

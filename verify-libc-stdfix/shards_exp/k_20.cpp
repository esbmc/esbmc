// expk (s16.15) vs camada's mkFXPExp -- SHARD 20/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 536870912 && xb <= 671088639);   /* shard 20 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 20: agrees with the exact exp");
  return 0;
}

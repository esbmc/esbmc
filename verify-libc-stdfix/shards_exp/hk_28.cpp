// exphk (s8.7) vs camada's mkFXPExp -- SHARD 28/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 24576 && xb <= 26623);   /* shard 28 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 28: agrees with the exact exp");
  return 0;
}

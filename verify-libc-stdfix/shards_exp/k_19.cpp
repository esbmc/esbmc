// expk (s16.15) vs camada's mkFXPExp -- SHARD 19/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 402653184 && xb <= 536870911);   /* shard 19 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 19: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 6/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1342177280 && xb <= -1207959553);   /* shard 6 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 6: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 31/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 2013265920 && xb <= 2147483647);   /* shard 31 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 31: agrees with the exact exp");
  return 0;
}

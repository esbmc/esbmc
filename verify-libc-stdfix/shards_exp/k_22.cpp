// expk (s16.15) vs camada's mkFXPExp -- SHARD 22/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 805306368 && xb <= 939524095);   /* shard 22 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 22: agrees with the exact exp");
  return 0;
}

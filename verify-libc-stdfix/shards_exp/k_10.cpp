// expk (s16.15) vs camada's mkFXPExp -- SHARD 10/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -805306368 && xb <= -671088641);   /* shard 10 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 10: agrees with the exact exp");
  return 0;
}

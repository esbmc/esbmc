// expk (s16.15) vs camada's mkFXPExp -- SHARD 9/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -939524096 && xb <= -805306369);   /* shard 9 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 9: agrees with the exact exp");
  return 0;
}

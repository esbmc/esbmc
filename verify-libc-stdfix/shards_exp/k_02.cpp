// expk (s16.15) vs camada's mkFXPExp -- SHARD 2/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1879048192 && xb <= -1744830465);   /* shard 2 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 2: agrees with the exact exp");
  return 0;
}

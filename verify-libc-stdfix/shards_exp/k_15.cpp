// expk (s16.15) vs camada's mkFXPExp -- SHARD 15/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -134217728 && xb <= -1);   /* shard 15 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 15: agrees with the exact exp");
  return 0;
}

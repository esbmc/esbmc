// exphk (s8.7) vs camada's mkFXPExp -- SHARD 10/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= -12288 && xb <= -10241);   /* shard 10 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 10: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 29/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1744830464 && xb <= 1879048191);   /* shard 29 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 29: agrees with the exact exp");
  return 0;
}

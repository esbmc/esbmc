// exphk (s8.7) vs camada's mkFXPExp -- SHARD 23/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 14336 && xb <= 16383);   /* shard 23 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 23: agrees with the exact exp");
  return 0;
}

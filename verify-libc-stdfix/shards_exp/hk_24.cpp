// exphk (s8.7) vs camada's mkFXPExp -- SHARD 24/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 16384 && xb <= 18431);   /* shard 24 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 24: agrees with the exact exp");
  return 0;
}

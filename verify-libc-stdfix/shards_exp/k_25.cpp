// expk (s16.15) vs camada's mkFXPExp -- SHARD 25/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1207959552 && xb <= 1342177279);   /* shard 25 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 25: agrees with the exact exp");
  return 0;
}

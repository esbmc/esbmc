// expk (s16.15) vs camada's mkFXPExp -- SHARD 7/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1207959552 && xb <= -1073741825);   /* shard 7 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 7: agrees with the exact exp");
  return 0;
}

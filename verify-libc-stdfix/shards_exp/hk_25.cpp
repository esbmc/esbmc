// exphk (s8.7) vs camada's mkFXPExp -- SHARD 25/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 18432 && xb <= 20479);   /* shard 25 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 25: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 24/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1073741824 && xb <= 1207959551);   /* shard 24 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 24: agrees with the exact exp");
  return 0;
}

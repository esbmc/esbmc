// expk (s16.15) vs camada's mkFXPExp -- SHARD 28/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1610612736 && xb <= 1744830463);   /* shard 28 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 28: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 11/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -671088640 && xb <= -536870913);   /* shard 11 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 11: agrees with the exact exp");
  return 0;
}

// exphk (s8.7) vs camada's mkFXPExp -- SHARD 22/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= 12288 && xb <= 14335);   /* shard 22 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 22: agrees with the exact exp");
  return 0;
}

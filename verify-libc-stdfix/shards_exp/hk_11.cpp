// exphk (s8.7) vs camada's mkFXPExp -- SHARD 11/32.
//
...
int main()
{
  ...
  __ESBMC_assume(xb >= -10240 && xb <= -8193);   /* shard 11 of 32 */
  ...
  __ESBMC_assert(lb == ob, "exphk shard 11: agrees with the exact exp");
  return 0;
}

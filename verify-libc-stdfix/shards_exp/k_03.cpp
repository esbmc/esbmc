// expk (s16.15) vs camada's mkFXPExp -- SHARD 3/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -1744830464 && xb <= -1610612737);   /* shard 3 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 3: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 1/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -2013265920 && xb <= -1879048193);   /* shard 1 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 1: agrees with the exact exp");
  return 0;
}

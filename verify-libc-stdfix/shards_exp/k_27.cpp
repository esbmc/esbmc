// expk (s16.15) vs camada's mkFXPExp -- SHARD 27/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= 1476395008 && xb <= 1610612735);   /* shard 27 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 27: agrees with the exact exp");
  return 0;
}

// expk (s16.15) vs camada's mkFXPExp -- SHARD 14/32.
//
...
{
  int xb = nondet_int();
  __ESBMC_assume(xb >= -268435456 && xb <= -134217729);   /* shard 14 of 32 */
  ...
  __ESBMC_assert(lb == ob, "expk shard 14: agrees with the exact exp");
  return 0;
}

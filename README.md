...
Run the following command to install ESBMC on Linux systems:

```sh
curl 'https://raw.githubusercontent.com/esbmc/esbmc/refs/heads/master/scripts/web-install.sh' | bash
```

...
* 43 awards from international competitions on software verification (SV-COMP) and testing (Test-Comp) 2012-2026 at TACAS/FASE (Strength: Bug Finding and Code Coverage).

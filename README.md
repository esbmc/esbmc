...
To get started, we recommend first reading some of the background material/publications to understand exactly what this technique can provide, which are available [online](https://ssvlab.github.io/esbmc/publications.html).
...
To build ESBMC with other SMT solvers, please see the [BUILDING](https://github.com/esbmc/esbmc/blob/master/BUILDING.md) file. 

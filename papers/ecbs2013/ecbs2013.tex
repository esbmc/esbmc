...
C := \left [ \begin{array}{ll}
        j_{0} = \mathit{select}(con_{0}, \mathit{size}) \\
        j_{1} = \mathit{store}(con_{1}, \mathit{size}, j_{0}+\mathit{qtd}) \\
        j_{2} = \mathit{store}(con_{1}, \mathit{ipos}, \mathit{val}) \\
        \ldots \\
        j_{2 + qtd - 1} = \mathit{store}(con_{1}, \mathit{ipos + qtd + 1}, \mathit{val}) \\
              \end{array} \right ]  \\
\end{equation}
...
C := \left [ \begin{array}{ll}
        j_{0} = \mathit{select}(con_{0}, \mathit{size}) \\
        j_{1} = \mathit{store}(con_{1}, \mathit{size}, j_{0}+\mathit{k}) \\
        j_{2} = \mathit{select}(acon, \mathit{ipos}) \\
	j_{3} = \mathit{store}(con_{1}, \mathit{ipos}, j_{3}) \\
        \ldots  \\
        j_{2 + k - 1} = \mathit{select}(acon, \mathit{it_{k - 1}}) \\
        j_{3 + k - 1} = \mathit{store}(con_{1}, \mathit{ipos + k - 1}, j_{2 + k - 1}) \\
              \end{array} \right ]  \\
\end{equation}
...
C := \left [ \begin{array}{ll}
        j_{0} = \mathit{select}(con_{0}, \mathit{size}) \\
        j_{1} = \mathit{store}(con_{1}, \mathit{size}, j_{0} - 1) \\
        j_{2} = \mathit{select}(con_{1}, \mathit{ipos + 1}) \\
	j_{3} = \mathit{store}(con_{1}, \mathit{ipos}, j_{2}) \\
        \ldots \\
        j_{2 + size - 1} = \mathit{select}(con_{1}, \mathit{ipos + size - 1}) \\
        j_{3 + size - 1} = \mathit{store}(con_{1}, \mathit{ipos + size - 1}, j_{2 + size - 1}) \\
              \end{array} \right ]  \\
\end{equation}
...
C := \left [ \begin{array}{ll}
        j_{0} = \mathit{select}(con_{0}, \mathit{size}) \\
        j_{1} = \mathit{store}(con_{1}, \mathit{size}, j_{0} - k) \\
        j_{2} = \mathit{select}(con_{1}, \mathit{it_{0} + k}) \\
	j_{3} = \mathit{store}(con_{1}, \mathit{it_{0}}, j_{2}) \\
      \ldots \\
        j_{2 + size - k} = \mathit{select}(con_{1}, \mathit{ipos + size - k}) \\
        j_{3 + size - k} = \mathit{store}(con_{1}, \mathit{ipos + size - k}, j_{2 + size - k}) \\
              \end{array} \right ]  \\
\end{equation}

...
\includegraphics[scale=0.45]{figures/esbmc-arch}
...
%------------------------------------------------------
%
The tool's architecture is shown in Figure~\ref{figure:esbmc-arch}. The first step is the source code parser,
...
On the goto programs step, the IRep will be converted on goto expressions.

...
IR if necessary, see Figure~\ref{figure:IR_uml_square}.
...
the verication fails. ESBMC also handles with virtual destructors successfully
and supports default constructor.

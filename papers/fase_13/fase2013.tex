...
conservatively approximates their semantics. We support this operational model
by extending our ESBMC tool~\cite{Cordeiro12} that in turn builds on top
...
C++ applications.  Additionally, we develop novel approaches to handle
...
\emph{general libraries}. In the verification process, the COM libraries
replace the corresponding actual C++ libraries.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\comment{
This operational model is inserted
...
libraries into that operational model; otherwise, ESBMC++ would not recognize
the methods of the library and would fail to parse the C++ programs.
...
\textit{strings}, and \textit{general utilities}.
The category \textit{language support}
...
The Standard Template Libraries (STL) makes up the biggest
part of the COM. It is split into
...
STL sequential containers, its preconditions and simulation features
(e.g., how we store the elements values of the containers
and intern class methods), and how these are used to
...
\begin{figure}[ht]
\centering
\includegraphics[scale=3.5]{figures/inheritance_uml}
...
MATCH($T_{t}$, $T_{C1}$, $T_{C2}$, ... , $T_{CN}$), where $T_{t}$ is
the type of the thrown exception and $T_{CN}$ is the n-th catch type.
The function is composed by several rules, and when one of the them is
true, then there is a match between the exception thrown and the catch
block. The function checks all the rules for each catch, in the order
that they are defined.

The first rules define a match if $T_{t}$ is equal to $T_{C}$ (ignoring
...
\[
\begin{array}{l}
  (T_{t} = (const $ $ | $ $ volatile $ $ | $ $ restrict) $ $ T $ $ \& $ $ T_{C} = T)\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = T_{f()} $ \& $ T_{C} = T_{f()})\rightarrow select(T_{C})
\end{array}
\]

\[
\begin{array}{l}
  (T_{t} = T[] $ \& $ T_{C} = T*)\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = T_{1} $ \& $ T_{C} = T_{2} $ \& $ BASE(T_{2}, T_{1}))\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = T_{1}* $ \& $ T_{C} = T_{2}* $ \& $ IMPLICIT\_CONV(T_{1}, T_{2}))\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = T* $ \& $ T_{C} = VOID*)\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = T $ \& $ T_{C} = T_{ellipsis})\rightarrow select(T_{C})
\end{array}
\]
...
\[
\begin{array}{l}
  (T_{t} = NULL $ \& $ T_{t-1} = T)\rightarrow MATCH(T,T_{C1}, T_{C2}... , T_{CN})
\end{array}
\]
...
1 & Algorithm & 127 & 3376 & 449 & 98 & 15 & 14 & 0 & 0 & 0 & 23454 & 98 & 1 & 2 & 0 & 25 & 1\\ % OK
\hline
2 & Deque & 43 & 1239 & 221 & 39 & 0 & 4 & 0 & 0 & 0 & 8582 & 33 & 0 & 0 & 1 & 9 & 0\\ % OK
\hline
3 & Vector & 146 & 6853 & 1160 & 136 & 3 & 7 & 0 & 0 & 0 & 7372 & 129 & 1 & 3 & 4 & 6 & 3\\ % OK
\hline
4 & List & 68 & 2292 & 2401 & 46 & 6 & 14 & 0 & 2 & 0 & 2859 & 31 & 5 & 28 & 0 & 0 & 4\\ % OK
\hline
5 & Queue & 14 & 328 & 65 & 14 & 0 & 0 & 0 & 0 & 0 & 44 & 13 & 0 & 1 & 0 & 0 & 0\\ % OK
\hline
6 & Stack & 12 & 286 & 34 & 12 & 0 & 0 & 0 & 0 & 0 & 45 & 12 & 0 & 0 & 0 & 0 & 0\\ % OK
\hline
7 & Inheritance & 51 & 3460 & 236 & 46 & 1 & 2 & 2 & 0 & 0 & 122 & 44 & 1 & 3 & 1 & 2 & 0\\ % OK
\hline
8 & Try\_catch & 67 & 4743 & 251 & 60 & 3 & 3 & 1 & 0 & 0 & 3 & 1 & 0 & 0 & 66 & 0 & 0 \\ % OK
\hline
9 & Stream & 66 & 1831 & 1002 & 65 & 0 & 1 & 0 & 0 & 0 & 12 & 30 & 0 & 35 & 1 & 0 & 0\\ % OK
\hline
10 & String & 231 & 4921 & 20555 & 225 & 6 & 8 & 0 & 0 & 0 & 37 & 128 & 4 & 101 & 0 & 0 & 0\\ % OK
\hline
11 & Cpp & 338 & 26624 & 1032 & 303 & 11 & 19 & 5 & 0 & 0 & 3445 & 260 & 9 & 51 & 15 & 2 & 1\\ % OK
\hline\hline
  &     &  1165 & 55953 & 27513 & 1044 & 45 & 66 & 8 & 2 & 0 & 45975 & 779 & 21 & 224 & 88 & 44 & 9\\ % OK
\hline
\end{tabular} }
\end{center}

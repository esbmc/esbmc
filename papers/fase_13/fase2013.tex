...
%as shown in Figure~\ref{figure:multiple-inheritance-IR}.
...
C := \left [ \begin{array}{ll}
        ...
        \wedge j_{5} = \left(j_{4}, width, 10\right) \\
        \wedge return\_value = \left(select\left(j_{5}, width\right) \times select\left(j_{5}, width\right)\right) \\
              \end{array} \right ],  \\
\end{equation}
%
\begin{equation}
\label{area-class-p}
P := \left [ \begin{array}{ll}
                j_{5}.\nu  \Rightarrow return\_value = 100 \\
              \end{array} \right ]  \\
\end{equation}
%
...
not directly connected. In Figure~\ref{figure:uml_diagram}, we have

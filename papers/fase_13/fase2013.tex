...
programming languages (e.g., Java) since it disallows the direct use of existing 
tools created to other programming languages. 
...
\begin{lstlisting}[style=nonumbers]
this1 == (struct Rectangle *)(&dynamic_1_value)
w1 == 10
h1 == 10
dynamic_1_value1 == 
   (dynamic_1_value0 WITH 
   [Rectangle@vtable_pointer:=&virtual_table::Rectangle@Rectangle])
dynamic_1_value2 == 
   (dynamic_1_value1 WITH 
   [width:=10])
dynamic_1_value3 == 
   (dynamic_1_value2 WITH 
   [heigth:=10])
dynamic_1_value4 == 
   (dynamic_1_value3 WITH 
   [Rectangle@vtable_pointer:=&virtual_table::Rectangle@Square])
dynamic_1_value5 == 
   (dynamic_1_value4 WITH 
   [Square@vtable_pointer:=&virtual_table::Square@Square])
dynamic_1_value6 == 
   (dynamic_1_value5 WITH 
   [width:=10])
sqre1 == &dynamic_1_value
this1 == &dynamic_1_value
return_value1 == 
   dynamic_1_value6.width * dynamic_1_value6.width
(assert)!__ESBMC_alloc1[POINTER_OBJECT(&dynamic_1_value)] => 
   return_value@1 == 100\end{lstlisting}
\end{minipage}
\caption{Intermediate Representation of \textit{Square} class}

...
\begin{itemize}
 ...
 \item If the throw has no arguments then it should rethrow the last thrown exception: ESBMC++ always keeps a reference of the last thrown exception and updates a rethrow if this reference is not NULL.
\end{itemize}

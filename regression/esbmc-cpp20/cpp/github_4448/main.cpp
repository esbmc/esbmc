// A symbolic in-range offset added to an iterator into a std::array reached
// through *std::bit_cast<Packet *>(buffer.data()) must not trip a bound check
// inside std::copy (#4448).
#include <algorithm>
#include <array>
#include <bit>
#include <cstddef>

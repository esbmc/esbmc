// #1902: --k-induction --multi-property kept incrementing k on this loop-free program.
...
int main() {
  ...
  printf("Time Travel Date: %02d/%02d/%d\n", time_travel_day, time_travel_month, time_travel_year);

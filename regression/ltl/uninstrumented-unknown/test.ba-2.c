...
ltl2ba_fsm(bool state_stats, unsigned int num_iters)
{
	...
	for (iters = 0; iters < num_iters; iters++) {
		...
		case _ltl2ba_state_0:
			state_is_viable = (((!_ltl2ba_cexpr_0_status()) || (_ltl2ba_cexpr_1_status())) || ((1)) || ((_ltl2ba_cexpr_1_status())) || ((false)));
			if (choice == 0) {
				__ESBMC_assume(((!_ltl2ba_cexpr_0_status()) || (_ltl2ba_cexpr_1_status())));
		...
		case _ltl2ba_state_1:
			state_is_viable = (((1)) || ((_ltl2ba_cexpr_1_status())) || ((false)));
			if (choice == 0) {
				__ESBMC_assume(((1)));
				_ltl2ba_statevar = _ltl2ba_state_1;
			} else if (choice == 1) {
...
_ltl2ba_sym_to_idx(void)
{
	...
	idx |= (_ltl2ba_cexpr_1_status()) ? 1 << 1 : 0;
	return idx;
}

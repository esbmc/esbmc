#if 0
generated by libltl2ba with command: ./ltl2ba -O c -f !G({pressed} -> F {charge > min})
...
{
	unsigned int idx = 0;
	idx |= (_ltl2ba_cexpr_1_status()) ? 1 : 0;
	idx |= (_ltl2ba_cexpr_0_status()) ? 2 : 0;
	return idx;
}

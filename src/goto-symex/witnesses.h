...
void create_graphml(boost::property_tree::ptree & graphml, std::string file_path){
	...
	key_control.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.name", '|'), "control");
	key_control.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.type", '|'), "string");
	...
	key_startline.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.name", '|'), "startline");
	key_startline.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.type", '|'), "int");
	...
	key_endline.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.name", '|'), "endline");
	key_endline.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.type", '|'), "int");
	...
	key_enterFunction.put(boost::property_tree::ptree::path_type("<xmlattr>|attr.name", '|'), "enterFunction");

...
expr2tc build_lhs(smt_convt &smt_conv, const expr2tc &lhs)
{
  ...
  renaming::renaming_levelt::get_original_name(new_lhs, symbol_renaming_level::level0);
  return new_lhs;
}
...
expr2tc build_rhs(smt_convt &smt_conv, const expr2tc &rhs)
{
  ...
  renaming::renaming_levelt::get_original_name(new_rhs, symbol_renaming_level::level0);
  return new_rhs;
}

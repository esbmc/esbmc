...
/*
 * Edoardo Manino: renamed to __k_sinl() to avoid a declaration
 * conflict with the vector function __sinl() in math.h
 */
long double __k_sinl(long double x, long double y, int iy)
{
	long double z,r,v;

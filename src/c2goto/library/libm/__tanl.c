...
/*
 * Edoardo Manino: renamed to __k_tanl() to avoid a declaration
 * conflict with the vector function __tanl() in math.h
 */
long double __k_tanl(long double x, long double y, int odd) {

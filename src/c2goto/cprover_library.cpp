...
const static std::vector<std::string> python_c_models = {
  "list_create",   "list_in_bounds",
  "list_at",       "list_cat",
  "list_get_as",   "list_push",
  "list_insert",   "list_push_object",
  "list_replace",  "list_pop",
  "list_size",     "list_hash_string",
  "list_eq",       "strncmp",
  "strcmp",        "strlen",
  "ceil",          "__ceil_array",
  ...
  "log2",          "ldexp",
  "log1p_taylor",  "strstr",
  "list_contains", "__python_str_isdigit",
};

...
const static std::vector<std::string> python_c_models = {
  "strncmp",      "strcmp",     "strlen",      "ceil",       "__ceil_array",
  "fegetround",   "fesetround", "rint",        "fesetround", "floor",
  "fabs",         "sin",        "cos",         "exp",        "expm1",
  "expm1_taylor", "fmod",       "sqrt",        "fmin",       "fmax",
  "trunc",        "frexp",      "round",       "copysign",   "arctan",
  "atan",         "_atan",      "atan2",       "acos",       "arccos",
  "dot",          "add",        "subtract",    "multiply",   "divide",
  "transpose",    "det",        "matmul",      "pow",        "log",

...
protected:
  ...
  // Not used
  void run_on_assume(symex_target_equationt::SSA_stept &) override
  {
  }
  void run_on_output(symex_target_equationt::SSA_stept &) override
  {
  }
  void run_on_skip(symex_target_equationt::SSA_stept &) override
  {
  }
  void run_on_renumber(symex_target_equationt::SSA_stept &) override
  {
  }

...
smt_astt cvc_convt::mk_smt_fpbv_is_nan(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_NAN, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_smt_fpbv_is_inf(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_INF, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_smt_fpbv_is_normal(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_NORMAL, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_smt_fpbv_is_zero(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_ZERO, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_smt_fpbv_is_negative(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_NEG, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_smt_fpbv_is_positive(smt_astt op)
{
  return new_ast(
    slv.mkTerm(
      cvc5::Kind::FLOATINGPOINT_IS_POS, {to_solver_smt_ast<cvc_smt_ast>(op)->a}),
    boolean_sort);
}
...
smt_astt cvc_convt::mk_bvneg(smt_astt a)
{
  assert(a->sort->id != SMT_SORT_INT && a->sort->id != SMT_SORT_REAL);
  return new_ast(
    slv.mkTerm(cvc5::Kind::BITVECTOR_NEG, {to_solver_smt_ast<cvc_smt_ast>(a)->a}),
    a->sort);
}
...
smt_astt cvc_convt::mk_bvnot(smt_astt a)
{
  assert(a->sort->id != SMT_SORT_INT && a->sort->id != SMT_SORT_REAL);
  return new_ast(
    slv.mkTerm(cvc5::Kind::BITVECTOR_NOT, {to_solver_smt_ast<cvc_smt_ast>(a)->a}),
    a->sort);
}
...
{
  return new solver_smt_sort<cvc5::Sort>(SMT_SORT_BOOL, slv.getBooleanSort(), 1);
}

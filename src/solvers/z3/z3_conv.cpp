...
smt_convt *create_new_z3_solver(bool int_encoding, const namespacet &ns,
...
z3_convt::z3_convt(bool int_encoding, const namespacet &_ns)
    : smt_convt(int_encoding, _ns), array_iface(true, true), fp_convt(this),
      z3_ctx(),
...
z3::expr z3_convt::mk_tuple_update(const z3::expr &t, unsigned i,
                                   const z3::expr &newval) {
...
smt_astt z3_convt::mk_add(smt_astt a, smt_astt b) {
  ...
  return new_ast((to_solver_smt_ast<z3_smt_ast>(a)->a +
...
smt_astt z3_convt::mk_mod(smt_astt a, smt_astt b) {
  ...
  assert(a->sort->id == b->sort->id);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_mod(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                    to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvsmod(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvsrem(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvumod(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvurem(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_div(smt_astt a, smt_astt b) {
  ...
  assert(a->sort->id == b->sort->id);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_div(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                    to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvsdiv(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvsdiv(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvudiv(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvudiv(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvshl(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvshl(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvashr(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvashr(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_bvlshr(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvlshr(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      a->sort);
}
...
smt_astt z3_convt::mk_implies(smt_astt a, smt_astt b) {
  ...
  return new_ast(implies(to_solver_smt_ast<z3_smt_ast>(a)->a,
                         to_solver_smt_ast<z3_smt_ast>(b)->a),
                 boolean_sort);
}
...
smt_astt z3_convt::mk_xor(smt_astt a, smt_astt b) {
  assert(a->sort->id == SMT_SORT_BOOL && b->sort->id == SMT_SORT_BOOL);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_xor(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                    to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_lt(smt_astt a, smt_astt b) {
  ...
  assert(b->sort->id == SMT_SORT_INT || b->sort->id == SMT_SORT_REAL);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_lt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                   to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvult(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvult(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvslt(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvslt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_gt(smt_astt a, smt_astt b) {
  ...
  assert(b->sort->id == SMT_SORT_INT || b->sort->id == SMT_SORT_REAL);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_gt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                   to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvugt(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvugt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvsgt(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvsgt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_le(smt_astt a, smt_astt b) {
  ...
  assert(b->sort->id == SMT_SORT_INT || b->sort->id == SMT_SORT_REAL);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_le(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                   to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvule(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvule(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvsle(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvsle(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_ge(smt_astt a, smt_astt b) {
  ...
  assert(b->sort->id == SMT_SORT_INT || b->sort->id == SMT_SORT_REAL);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_ge(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                                   to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvuge(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvuge(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_bvsge(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_bvsge(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                              to_solver_smt_ast<z3_smt_ast>(b)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_store(smt_astt a, smt_astt b, smt_astt c) {
  ...
  assert(a->sort->get_range_sort()->get_data_width() ==
         c->sort->get_data_width());
  return new_ast(store(to_solver_smt_ast<z3_smt_ast>(a)->a,
                       to_solver_smt_ast<z3_smt_ast>(b)->a,
...
smt_astt z3_convt::mk_select(smt_astt a, smt_astt b) {
  assert(a->sort->id == SMT_SORT_ARRAY);
  assert(a->sort->get_domain_width() == b->sort->get_data_width());
  return new_ast(select(to_solver_smt_ast<z3_smt_ast>(a)->a,
                        to_solver_smt_ast<z3_smt_ast>(b)->a),
...
smt_astt z3_convt::mk_real2int(smt_astt a) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_real2int(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a)),
      mk_int_sort());
}
...
smt_astt z3_convt::mk_int2real(smt_astt a) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_int2real(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a)),
      mk_real_sort());
}
...
smt_astt z3_convt::mk_isint(smt_astt a) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_is_int(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_extract(smt_astt a, unsigned int high, unsigned int low) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_extract(z3_ctx, high, low,
...
smt_astt z3_convt::mk_sign_ext(smt_astt a, unsigned int topwidth) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_sign_ext(z3_ctx, topwidth,
                                         to_solver_smt_ast<z3_smt_ast>(a)->a)),
      s);
}
...
smt_astt z3_convt::mk_zero_ext(smt_astt a, unsigned int topwidth) {
  smt_sortt s = mk_bv_sort(a->sort->get_data_width() + topwidth);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_zero_ext(z3_ctx, topwidth,
                                         to_solver_smt_ast<z3_smt_ast>(a)->a)),
      s);
}
...
smt_astt z3_convt::mk_concat(smt_astt a, smt_astt b) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_concat(z3_ctx, to_solver_smt_ast<z3_smt_ast>(a)->a,
                               to_solver_smt_ast<z3_smt_ast>(b)->a)),
      s);
}
...
smt_astt z3_convt::mk_ite(smt_astt cond, smt_astt t, smt_astt f) {
  ...
  return new_ast(ite(to_solver_smt_ast<z3_smt_ast>(cond)->a,
...
smt_astt z3_convt::mk_smt_fpbv(const ieee_floatt &thereal) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_fp(z3_ctx, to_solver_smt_ast<z3_smt_ast>(sgn_bv)->a,
...
smt_astt z3_convt::mk_smt_fpbv_nan(unsigned ew, unsigned sw) {
  ...
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_nan(z3_ctx, to_solver_smt_sort<z3::sort>(s)->s)),
      s);
}
...
smt_astt z3_convt::mk_smt_fpbv_inf(bool sgn, unsigned ew, unsigned sw) {
  smt_sortt s = mk_real_fp_sort(ew, sw - 1);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_inf(
                              z3_ctx, to_solver_smt_sort<z3::sort>(s)->s, sgn)),
      s);
}
...
smt_astt z3_convt::mk_array_symbol(const std::string &name, const smt_sort *s,
...
smt_sortt z3_convt::mk_struct_sort(const type2tc &type) {
  ...
  z3::sort sort =
      to_sort(z3_ctx, Z3_mk_tuple_sort(z3_ctx, tuple_name, num_members,
                                       member_names.ptr(), member_sorts.ptr(),
                                       &mk_tuple_decl, proj_decls.ptr()));

  return new solver_smt_sort<z3::sort>(SMT_SORT_STRUCT, sort, type);
}

smt_astt z3_smt_ast::update(smt_convt *conv, smt_astt value, unsigned int idx,
...
smt_astt z3_convt::convert_array_of(smt_astt init_val,
  ...
  z3::expr output = z3::to_expr(
      z3_ctx, Z3_mk_const_array(
                  z3_ctx, to_solver_smt_sort<z3::sort>(dom_sort)->s, val));

  return new_ast(output, mk_array_sort(dom_sort, init_val->sort));
}

smt_astt z3_convt::tuple_array_create(const type2tc &arr_type,
                                      smt_astt *input_args, bool const_array,
...
smt_astt z3_convt::tuple_array_of(const expr2tc &init,
                                  unsigned long domain_width) {
...
expr2tc z3_convt::tuple_get(const expr2tc &expr) {
  ...
  if (is_pointer_type(expr->type)) {
    ...
    smt_astt object =
        new_ast(mk_tuple_select(to_solver_smt_ast<z3_smt_ast>(sym)->a, 0),
                convert_sort(strct.members[0]));

    smt_astt offset =
        new_ast(mk_tuple_select(to_solver_smt_ast<z3_smt_ast>(sym)->a, 1),
...
ieee_floatt z3_convt::get_fpbv(smt_astt a) {
  ...
  if (Z3_fpa_is_numeral_nan(z3_ctx, e))
    ...
    Z3_ast v;
    if (Z3_model_eval(z3_ctx, solver.get_model(),
                      Z3_mk_fpa_to_ieee_bv(z3_ctx, e), 1, &v))
...
expr2tc z3_convt::get_array_elem(smt_astt array, uint64_t index,
...
void z3_convt::dump_smt() { std::cout << solver << std::endl; }

smt_astt z3_convt::mk_smt_fpbv_gt(smt_astt lhs, smt_astt rhs) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_gt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(lhs)->a,
...
smt_astt z3_convt::mk_smt_fpbv_lt(smt_astt lhs, smt_astt rhs) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_lt(z3_ctx, to_solver_smt_ast<z3_smt_ast>(lhs)->a,
                               to_solver_smt_ast<z3_smt_ast>(rhs)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_gte(smt_astt lhs, smt_astt rhs) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_geq(z3_ctx, to_solver_smt_ast<z3_smt_ast>(lhs)->a,
                                to_solver_smt_ast<z3_smt_ast>(rhs)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_lte(smt_astt lhs, smt_astt rhs) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_leq(z3_ctx, to_solver_smt_ast<z3_smt_ast>(lhs)->a,
                                to_solver_smt_ast<z3_smt_ast>(rhs)->a)),
      boolean_sort);
}
...
smt_sortt z3_convt::mk_fpbv_rm_sort() {
  return new solver_smt_sort<z3::sort>(
      SMT_SORT_FPBV_RM, z3::sort(z3_ctx, Z3_mk_fpa_rounding_mode_sort(z3_ctx)),
      3);
}
...
smt_sortt z3_convt::mk_bv_sort(std::size_t width) {
  return new solver_smt_sort<z3::sort>(SMT_SORT_BV, z3_ctx.bv_sort(width),
                                       width);
}

smt_sortt z3_convt::mk_fbv_sort(std::size_t width) {
  return new solver_smt_sort<z3::sort>(SMT_SORT_FIXEDBV, z3_ctx.bv_sort(width),
                                       width);
}
...
smt_sortt z3_convt::mk_array_sort(smt_sortt domain, smt_sortt range) {
  ...
  return new solver_smt_sort<z3::sort>(SMT_SORT_ARRAY, t,
                                       domain->get_data_width(), range);
}

smt_astt z3_convt::mk_from_bv_to_fp(smt_astt op, smt_sortt to) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_to_fp_bv(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a,
                              to_solver_smt_sort<z3::sort>(to)->s)),
      to);
}

smt_astt z3_convt::mk_from_fp_to_bv(smt_astt op) {
  smt_sortt to = mk_bvfp_sort(op->sort->get_exponent_width(),
                              op->sort->get_significand_width() - 1);
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_to_ieee_bv(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      to);
}

smt_astt z3_convt::mk_smt_typecast_from_fpbv_to_ubv(smt_astt from,
                                                    std::size_t width) {
...
smt_astt z3_convt::mk_smt_typecast_from_fpbv_to_sbv(smt_astt from,
                                                    std::size_t width) {
  // Conversion from float to integers always truncate, so we assume
  // the round mode to be toward zero
  const z3_smt_ast *mrm =
...
smt_astt z3_convt::mk_smt_typecast_from_fpbv_to_fpbv(smt_astt from,
                                                     smt_sortt to,
                                                     smt_astt rm) {
  const z3_smt_ast *mrm = to_solver_smt_ast<z3_smt_ast>(rm);
  const z3_smt_ast *mfrom = to_solver_smt_ast<z3_smt_ast>(from);
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_to_fp_float(
                                         z3_ctx, mrm->a, mfrom->a,
                                         to_solver_smt_sort<z3::sort>(to)->s)),
                 to);
}

smt_astt z3_convt::mk_smt_typecast_ubv_to_fpbv(smt_astt from, smt_sortt to,
                                               smt_astt rm) {
  const z3_smt_ast *mrm = to_solver_smt_ast<z3_smt_ast>(rm);
  const z3_smt_ast *mfrom = to_solver_smt_ast<z3_smt_ast>(from);
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_to_fp_unsigned(
                                         z3_ctx, mrm->a, mfrom->a,
                                         to_solver_smt_sort<z3::sort>(to)->s)),
                 to);
}

smt_astt z3_convt::mk_smt_typecast_sbv_to_fpbv(smt_astt from, smt_sortt to,
                                               smt_astt rm) {
  const z3_smt_ast *mrm = to_solver_smt_ast<z3_smt_ast>(rm);
  const z3_smt_ast *mfrom = to_solver_smt_ast<z3_smt_ast>(from);
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_to_fp_signed(
                                         z3_ctx, mrm->a, mfrom->a,
                                         to_solver_smt_sort<z3::sort>(to)->s)),
                 to);
}
...
smt_astt z3_convt::mk_smt_nearbyint_from_float(smt_astt from, smt_astt rm) {
  const z3_smt_ast *mrm = to_solver_smt_ast<z3_smt_ast>(rm);
  const z3_smt_ast *mfrom = to_solver_smt_ast<z3_smt_ast>(from);
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_round_to_integral(z3_ctx, mrm->a,
                                                                 mfrom->a)),
                 from->sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_sqrt(smt_astt rd, smt_astt rm) {
  ...
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_sqrt(z3_ctx, mrm->a, mrd->a)),
                 rd->sort);
}

smt_astt z3_convt::mk_smt_fpbv_fma(smt_astt v1, smt_astt v2, smt_astt v3,
                                   smt_astt rm) {
  const z3_smt_ast *mrm = to_solver_smt_ast<z3_smt_ast>(rm);
  ...
  return new_ast(z3::to_expr(z3_ctx, Z3_mk_fpa_fma(z3_ctx, mrm->a, mv1->a,
                                                   mv2->a, mv3->a)),
                 v1->sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_eq(smt_astt lhs, smt_astt rhs) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_eq(z3_ctx, to_solver_smt_ast<z3_smt_ast>(lhs)->a,
                               to_solver_smt_ast<z3_smt_ast>(rhs)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_nan(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_nan(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_inf(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_infinite(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_normal(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_normal(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_zero(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_zero(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_negative(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_negative(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_is_positive(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx, Z3_mk_fpa_is_positive(
                              z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      boolean_sort);
}
...
smt_astt z3_convt::mk_smt_fpbv_abs(smt_astt op) {
  return new_ast(
      z3::to_expr(z3_ctx,
                  Z3_mk_fpa_abs(z3_ctx, to_solver_smt_ast<z3_smt_ast>(op)->a)),
      op->sort);
}

...
const struct group_opt_templ all_cmd_options[] = {
  ...
  {"Solver",
   {{"list-solvers", NULL, "list available solvers and exit"},
    ...
    {"z3-debug-dump-file", boost::program_options::value<std::string>()->value_name("z3.log"), "name for Z3 dump file"},
    {"z3-debug-smt-file", boost::program_options::value<std::string>()->value_name("log.smt2"), "name for Z3 smt2 file"},

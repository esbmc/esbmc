  ...
  {"Miscellaneous options",
   {
     ...
     {"interval-analysis-arithmetic",
      NULL,
      "enable interval arithmetic for integer variables"},
     {"interval-analysis-modular",
      NULL,
      "enable modular arithmetic for integer variables"},
     {"interval-analysis-simplify",
      NULL,
      "enable assertion simplification during interval analysis"},
     {"interval-analysis-no-contract",
      NULL,
      "disables use of contractors in abstract states"},
     {"interval-analysis-no-extrapolate",
      NULL,
      "disables use of extrapolation in abstract states"},

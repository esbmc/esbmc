...
const struct group_opt_templ all_cmd_options[] = {
  ...
  {"Printing options",
   {{"symbol-table-only", NULL, "only show symbol table"},
    ...
    {"rapid-program-only", NULL, "only show rapid program (if option --rapid set)"},
    {"rapid-program-too", NULL, "show rapid program and verify (if option --rapid set)"},    
  ...
  {"k-induction",
   {{"base-case", NULL, "check the base case"},
    ...
    {"rapid", NULL, 
     "use Rapid first-order based verification as an alternative to k-induction"},
    {"rapid-path",
     boost::program_options::value<std::string>()->value_name("rapid-path"),
     "path to Rapid executable"},     
    {"rapid-options",
     boost::program_options::value<std::string>()->value_name("rapid-options"),
     "options to pass to Rapid program verifier"},
    {"vampire-path",

...
def annotate_function_with_env_and_signatures(func_node, out_envs, return_types,
                                              context: InferenceContext):
...
def type_to_ast_annotation(t: Type) -> ast.expr:
    ...
    raise TypeError(f"Cannot convert lattice type to AST annotation: "
                    f"{type(t).__name__}")

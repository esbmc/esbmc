...
bool contextt::move(symbolt &symbol, symbolt *&new_symbol)
{
  ...
  {
    std::string temp = "Bird::~Bird(this)";
    ...
    temp = "Bird::~Bird(this)::Bird::~Bird(this)::this";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());
    ...
    temp = "Bird::Bird(this,ref_symbol(identifier=tag.Bird,#constant=1_1))";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Bird::do_something(this)";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Bird::do_something(this)::Bird::do_something(this)::this";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp =
      "Bird::operator=(this,ref_symbol(identifier=tag.Bird,#constant=1_1))";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());
    ...
    temp = "virtual_table::tag.Bird";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "virtual_table::tag.Bird@tag.Bird";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());
  }

  {
    std::string temp = "tag.Penguin";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::do_something(this)";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "virtual_table::tag.Penguin";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::do_something(this)::tag.Bird::this";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::do_something(this)::tag.Bird";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::~Penguin(this)";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "virtual_table::tag.Bird@tag.Penguin";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "virtual_table::tag.Penguin@tag.Penguin";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());
    ...
    temp =
      "Penguin::Penguin(this,ref_symbol(identifier=tag.Penguin,#constant=1_1))";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp =
      "Penguin::operator=(this,ref_symbol(identifier=tag.Penguin,#constant=1_1)"
      ")";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::do_something(this)::Penguin::do_something(this)::this";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

    temp = "Penguin::~Penguin(this)::Penguin::~Penguin(this)::this";
    if(symbol.id.as_string() == temp)
      printf("Got %s\n", temp.c_str());

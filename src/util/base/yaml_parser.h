...
public:
  ...
  /// Callers may modify waypoints in place (e.g. fill parsed_cond); changes
  /// persist for the lifetime of the process.  Do not store the reference
  /// across calls that pass a different witness path.

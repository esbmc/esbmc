...
| `irep2_templates.h` / `templates/irep2_templates.cpp` | Per-field-type helpers (`do_type2string`, `do_get_sub_expr`, `do_count_sub_exprs`, `call_*_delegate`) used by the generic dispatchers, plus the kind `field_names` tables. |

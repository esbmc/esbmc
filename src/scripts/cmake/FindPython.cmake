...
if(ENABLE_PYTHON)
  ...
  message("Looking for boost python (slow)")
  # Because python 2 continues to exist, and it's not a specific part of boost
  # python, we need to do some manual looking first. Debian produces a boost
  # python with a version suffix...
  find_library(BOOST_PYTHON "boost_python-py${PYMAJOR}${PYMINOR}")
  ...
  if (didbpcompile)
    message("Found boost python: ${BOOST_PYTHON}")
  else()
    set (NO_PYTHON 1)
    if ("${BOOST_PYTHON}" STREQUAL "BOOST_PYTHON-NOTFOUND")
  ...
  if (DEFINED NO_PYTHON)
    ...
    set (HAVE_PYTHON "1")
    set (PYTHON_LINK_LIBS "${BOOST_PYTHON};${PYTHON_LIBRARIES}")
  endif()
else()

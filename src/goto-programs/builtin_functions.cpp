  ...
  goto_programt &dest)
{
  ...
  if (
    ...
    function.location().function() != "pthread_mutex_init" &&
    function.location().function() != "pthread_mutex_lock_noassert" &&
    function.location().function() != "pthread_mutex_unlock_noassert" &&

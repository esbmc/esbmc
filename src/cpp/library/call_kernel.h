...
typedef void* (*voidFunction_three_u)(unsigned arg, unsigned arg2, unsigned arg3);

	/*ESBMC_verify_kernel_f()*/
typedef void* (*voidFunction_float)(float* arg1);
typedef void* (*voidFunction_ffloat)(float* arg1, float arg2);
typedef void* (*voidFunction_f5i2)(float* arg1, float* arg2, float* arg3, float* arg4, float* arg5, int arg6, int arg7);
...
typedef void* (*voidFunction_fuintint)(float* arg1, unsigned int arg2, int arg3);
...
typedef void* (*voidFunction_i_ui_ull_f)(int* arg1, unsigned int* arg2,	unsigned long long int* arg3,float* arg4);

	/*ESBMC_verify_kernel_ui*/
typedef void* (*voidFunction_one_ui)(unsigned int* arg);  /* CONSERTAR ESTA DUPLICAÇÃO!! */
...
void *ESBMC_execute_kernel_f5i2(void *args) {
	//ESBMC_atomic_begin();
	dev_f5i2.func(dev_f5i2.a, dev_f5i2.b, dev_f5i2.c, dev_f5i2.d, dev_f5i2.e, dev_f5i2.f, dev_f5i2.g);
	//ESBMC_atomic_end();
	return NULL;
}
...
void *ESBMC_execute_kernel_four_i_ui_ull_f(void *args) {
	//ESBMC_atomic_begin();
	dev_four_i_ui_ull_f.func(dev_four_i_ui_ull_f.a, dev_four_i_ui_ull_f.b,
	dev_four_i_ui_ull_f.c, dev_four_i_ui_ull_f.d );
	//ESBMC_atomic_end();
	return NULL;
}
...
void ESBMC_verify_kernel_with_one_arg(void *(*kernel)(int*), int blocks, int threads,
		void* arg1) {
	__ESBMC_atomic_begin();
...
void ESBMC_verify_kernel_with_two_args(void *(*kernel)(int*, int*), int blocks,
...
void ESBMC_verify_kernel_with_three_args(void *(*kernel)(int*, int*, int*),
	...
	/*ESBMC_verify_kernel_i()*/
void ESBMC_verify_kernel_with_two_args_i(void *(*kernel)(int, int), int blocks,
		int threads, int arg1, int arg2) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_u()*/
void ESBMC_verify_kernel_with_one_args_u(void *(*kernel)(uint4*),
		int blocks, int threads, void* arg1) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
...
void ESBMC_verify_kernel_with_two_args_u(void *(*kernel)(unsigned int*, int*), int blocks,
		int threads, void* arg1, void* arg2) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
...
void ESBMC_verify_kernel_with_three_args_u(void *(*kernel)(unsigned, unsigned, unsigned),
		int blocks, int threads, unsigned arg1, unsigned arg2, unsigned arg3) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_f()*/
void ESBMC_verify_kernel_float(void *(*kernel)(float*), int blocks,
...
void ESBMC_verify_kernel_ffloat(void *(*kernel)(float*, float), int blocks,
...
void ESBMC_verify_kernel_f5i2(void *(*kernel)(float*, float*, float*, float*, float*, int, int), int blocks,
		int threads, void* arg1, void* arg2, void* arg3, void* arg4, void* arg5, int arg6, int arg7) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_c()*/
void ESBMC_verify_kernel_d1(void *(*kernel)(double*), int blocks,
		int threads, void* arg1) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
...
void ESBMC_verify_kernel_d2(void *(*kernel)(double, int), int blocks, int threads,
...
void ESBMC_verify_kernel_c3(void *(*kernel)(char*, char*, char*), int blocks,
		int threads, void* arg1, void* arg2, void* arg3) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_intt()*/
void ESBMC_verify_kernel__intt(void *(*kernel)(int*, int), int blocks, int threads,
		void* arg1, int arg2) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_fuintt()*/
void ESBMC_verify_kernel__fuintt(void *(*kernel)(float*, unsigned int, unsigned int),
...
void ESBMC_verify_kernel__fuint(void *(*kernel)(float*, unsigned int),
		int blocks, int threads, void* arg1, unsigned int arg2) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	...
	/*ESBMC_verify_kernel_fuintint()*/
void ESBMC_verify_kernel__fuintint(void *(*kernel)(float*, unsigned int, int),
	int blocks, int threads, void* arg1, unsigned int arg2,
	int arg3) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
...
void ESBMC_verify_kernel__fint(void *(*kernel)(float*, int),
	int blocks, int threads, void* arg1, int arg2)
{
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
...
void ESBMC_verify_kernel_with_three_args_iuull(
	...
	dev_three_iuull.b = (unsigned int*) malloc(GPU_threads * sizeof(unsigned int));
	//dev_three_iuull.c = (unsigned long long int*) malloc(n_threads * sizeof(unsigned long long int));
	dev_three_iuull.c = (unsigned long long int*) malloc(GPU_threads * sizeof(unsigned long long int));
	...
	while (i < GPU_threads) {
	//while (i < 2) {
		pthread_create(&threads_id[i], NULL, ESBMC_execute_kernel_three_iuull, NULL);
		i++;
	}
	__ESBMC_atomic_end();
}
...
void ESBMC_verify_kernel_with_four__args_i_ui_ull_f(
		...
		int blocks, int threads, void* arg1, void* arg2, void* arg3, void* arg4) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
	//threads_id = (pthread_t *) malloc(2 * sizeof(pthread_t));
	...
	dev_four_i_ui_ull_f.b = (unsigned int*) malloc(GPU_threads * sizeof(unsigned int));
	//dev_four_i_ui_ull_f.c = (unsigned long long int*) malloc(n_threads * sizeof(unsigned long long int));
	dev_four_i_ui_ull_f.c = (unsigned long long int*) malloc(GPU_threads * sizeof(unsigned long long int));
	...
	while (i < GPU_threads) {
	//while (i < 2) {
		pthread_create(&threads_id[i], NULL, ESBMC_execute_kernel_four_i_ui_ull_f, NULL);
		i++;
	}
	__ESBMC_atomic_end();
}
...
void ESBMC_verify_kernel_one_ui(void *(*kernel)(unsigned int*), int blocks,
		int threads, void* arg1) {
	__ESBMC_atomic_begin();
	//n_threads = blocks * threads;
	threads_id = (pthread_t *) malloc(GPU_threads * sizeof(pthread_t));
...
void ESBMC_verify_kernel(RET *kernel, BLOCK blocks, THREAD threads) {
	...
	ESBMC_verify_kernel_no_params((voidFunction_no_params) kernel,
...
void ESBMC_verify_kernel(RET *kernel, BLOCK blocks, THREAD threads, T1 arg) {
	...
	ESBMC_verify_kernel_with_one_arg((voidFunction_one) kernel,
			gridDim.x * gridDim.y * gridDim.z,
...
void ESBMC_verify_kernel(RET *kernel, BLOCK blocks, THREAD threads, T1 arg, T2 arg2) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel_with_two_args((voidFunction_two) kernel,
			gridDim.x * gridDim.y * gridDim.z,
...
void ESBMC_verify_kernel(RET *kernel, BLOCK blocks, THREAD threads, T1 arg, T2 arg2,
	...
	ESBMC_verify_kernel_with_three_args((voidFunction_three) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2,
			(void*) arg3);
	...
	/*ESBMC_verify_kernel_i*/
template<class RET, class BLOCK, class THREAD, class T1, class T2>
void ESBMC_verify_kernel_i(RET *kernel, BLOCK blocks, THREAD threads, T1 arg, T2 arg2) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel_with_two_args_i((voidFunction_two_i) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, arg, arg2);
...
void ESBMC_verify_kernel_u(RET *kernel, BLOCK blocks, THREAD threads, T1 arg) {
	...
	ESBMC_verify_kernel_with_one_args_u((voidFunction_one_u) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z,  arg);
...
template<class RET, class BLOCK, class THREAD, class T1, class T2>
void ESBMC_verify_kernel_u(RET *kernel, BLOCK blocks, THREAD threads, T1 arg, T2 arg2) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel_with_two_args_u((voidFunction_two_u) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2);
...
void ESBMC_verify_kernel_u(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel_with_three_args_u((voidFunction_three_u) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z,  arg,  arg2,
			 arg3);
...
void ESBMC_verify_kernel_f(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel_ffloat((voidFunction_ffloat) kernel,
			gridDim.x * gridDim.y * gridDim.z,
...
void ESBMC_verify_kernel_f(RET *kernel, BLOCK blocks, THREAD threads, T1 arg) {
	...
	ESBMC_verify_kernel_float((voidFunction_float) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg);
...
template<class RET, class BLOCK, class THREAD, class T1, class T2, class T3, class T4, class T5, class T6, class T7>
void ESBMC_verify_kernel_f(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel_f5i2((voidFunction_f5i2) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2, (void*) arg3, (void*) arg4, (void*) arg5,
			arg6, arg7);
...
void ESBMC_verify_kernel_c(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel_c3((voidFunction_c3) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2, (void*) arg3);
...
void ESBMC_verify_kernel_c(RET *kernel, BLOCK blocks, THREAD threads, T1 arg) {
	...
	ESBMC_verify_kernel_d1((voidFunction_d1) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg);
...
void ESBMC_verify_kernel_c(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel_d2((voidFunction_d2) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, arg, arg2);
	...
	/*ESBMC_verify_kernel_intt()*/
template<class RET, class BLOCK, class THREAD, class T1, class T2>
void ESBMC_verify_kernel_intt(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
		T2 arg2) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel__intt((voidFunction_intt) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, arg2);
	...
	/*ESBMC_verify_kernel_fuintt()*/
template<class RET, class BLOCK, class THREAD, class T1, class T2, class T3>
void ESBMC_verify_kernel_fuintt(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
		T2 arg2, T3 arg3) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel__fuintt((voidFunction_fuintt) kernel,
			gridDim.x * gridDim.y * gridDim.z,
...
void ESBMC_verify_kernel_fuintt(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel__fuint((voidFunction_fuint) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, arg2);
	...
	/*ESBMC_verify_kernel_fuintint()*/
template<class RET, class BLOCK, class THREAD, class T1, class T2, class T3>
void ESBMC_verify_kernel_fuintint(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
		T2 arg2, T3 arg3) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel__fuintint((voidFunction_fuintint) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, arg2, arg3);
...
void ESBMC_verify_kernel_fuintint(RET *kernel, BLOCK blocks, THREAD threads, T1 arg,
	...
	ESBMC_verify_kernel__fint((voidFunction_fint) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, arg2);
...
template<class RET, class BLOCK, class THREAD, class T1, class T2, class T3>
void ESBMC_verify_kernel_three_args_iuull(RET *kernel, BLOCK blocks, THREAD threads,
		T1 arg, T2 arg2, T3 arg3) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel_with_three_args_iuull((voidFunction_iuull) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2,
			(void*) arg3);
...
template<class RET, class BLOCK, class THREAD, class T1, class T2, class T3, class T4>
void ESBMC_verify_kernel_four(RET *kernel, BLOCK blocks, THREAD threads,
		T1 arg, T2 arg2, T3 arg3, T4 arg4) {
	//ESBMC_atomic_begin();
	gridDim = dim3(blocks);
	blockDim = dim3(threads);

	ESBMC_verify_kernel_with_four__args_i_ui_ull_f((voidFunction_i_ui_ull_f) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg, (void*) arg2, (void*) arg3, (void*) arg4);
...
void ESBMC_verify_kernel_ui(RET *kernel, BLOCK blocks, THREAD threads, T1 arg) {
	...
	ESBMC_verify_kernel_one_ui((voidFunction_one_ui) kernel,
			gridDim.x * gridDim.y * gridDim.z,
			blockDim.x * blockDim.y * blockDim.z, (void*) arg);

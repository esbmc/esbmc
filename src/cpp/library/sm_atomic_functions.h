...
extern __device__ __device_builtin__ unsigned long long int __ullAtomicAnd(unsigned long long int *address, unsigned long long int val);
...
static __inline__ __device__ long long atomicMin(long long *address, long long val)
{
    return __illAtomicMin(address, val);
}

static __inline__ __device__ long long atomicMax(long long *address, long long val)
{
    return __illAtomicMax(address, val);
}

static __inline__ __device__ unsigned long long atomicMin(unsigned long long *address, unsigned long long val)
{
    return __ullAtomicMin(address, val);
}

static __inline__ __device__ unsigned long long atomicMax(unsigned long long *address, unsigned long long val)
{
    return __ullAtomicMax(address, val);
}

static __inline__ __device__ unsigned long long int atomicAnd(unsigned long long int *address, unsigned long long int val)
{
    return __ullAtomicAnd(address, val);
}

static __inline__ __device__ unsigned long long atomicOr(unsigned long long *address, unsigned long long val)
{
    return __ullAtomicOr(address, val);
}

static __inline__ __device__ unsigned long long atomicXor(unsigned long long *address, unsigned long long val)
{

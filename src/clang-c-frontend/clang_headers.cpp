...
extern "C" {
  ...
  struct hooked_header clang_headers[] = {
    ...
    { "clang_coverage_interface.h", clang_coverage_interface_buf, &clang_coverage_interface_buf_size},
    { "clang_allocator_interface.h", clang_allocator_interface_buf, &clang_allocator_interface_buf_size},
    { "clang_dfsan_interface.h", clang_dfsan_interface_buf, &clang_dfsan_interface_buf_size},
    { "clang_common_interface_defs.h", clang_common_interface_defs_buf, &clang_common_interface_defs_buf_size},
    { "clang_msan_interface.h", clang_msan_interface_buf, &clang_msan_interface_buf_size},
    { "clang_tsan_interface_atomic.h", clang_tsan_interface_atomic_buf, &clang_tsan_interface_atomic_buf_size},
    { "clang_linux_syscall_hooks.h", clang_linux_syscall_hooks_buf, &clang_linux_syscall_hooks_buf_size},
    { "clang_lsan_interface.h", clang_lsan_interface_buf, &clang_lsan_interface_buf_size},
    { "clang_asan_interface.h", clang_asan_interface_buf, &clang_asan_interface_buf_size},
    { NULL, NULL, NULL}
  };
}

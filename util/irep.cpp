...
const irep_idt irept::id_array_of = dstring("array_of");
const irep_idt irept::id_ashr = dstring("ashr");
const irep_idt irept::id_bitand = dstring("bitand");
const irep_idt irept::id_bitnot = dstring("bitnot");
const irep_idt irept::id_bitor = dstring("bitor");
const irep_idt irept::id_bitxor = dstring("bitxor");
const irep_idt irept::id_bv = dstring("bv");
const irep_idt irept::id_byte_extract_big_endian = dstring("byte_extract_big_endian");
const irep_idt irept::id_byte_extract_little_endian = dstring("byte_extract_little_endian");
const irep_idt irept::id_byte_update_big_endian = dstring("byte_update_big_endian");
const irep_idt irept::id_byte_update_little_endian = dstring("byte_update_little_endian");
const irep_idt irept::id_c_enum = dstring("c_enum");
const irep_idt irept::id_dynamic_object = dstring("dynamic_object");
const irep_idt irept::id_dynamic_size = dstring("dynamic_size");
const irep_idt irept::id_if = dstring("if");
const irep_idt irept::id_implicit_address_of = dstring("implicit_address_of");
const irep_idt irept::id_implicit_dereference = dstring("implicit_dereference");
const irep_idt irept::id_incomplete_c_enum = dstring("incomplete_c_enum");
const irep_idt irept::id_incomplete_struct = dstring("incomplete_struct");
const irep_idt irept::id_incomplete_union = dstring("incomplete_union");
const irep_idt irept::id_integer = dstring("integer");
const irep_idt irept::id_invalid = dstring("invalid");
const irep_idt irept::id_nondet_symbol = dstring("nondet_symbol");
const irep_idt irept::id_null_object = dstring("NULL-object");
const irep_idt irept::id_or = dstring("or");
const irep_idt irept::id_reference = dstring("reference");
const irep_idt irept::id_reference_to = dstring("reference_to");
const irep_idt irept::id_sideeffect = dstring("sideeffect");
const irep_idt irept::id_string_constant = dstring("string-constant");
const irep_idt irept::id_unary_sub = dstring("unary-");

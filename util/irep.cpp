...
irep_idt irept::a_column = dstring("column");
irep_idt irept::a_access = dstring("access");
irep_idt irept::a_destination = dstring("destination");
irep_idt irept::a_base_name = dstring("base_name");
irep_idt irept::a_comment = dstring("comment");
irep_idt irept::a_event = dstring("event");
irep_idt irept::a_literal = dstring("literal");
irep_idt irept::a_loopid = dstring("loop-id");
irep_idt irept::a_mode = dstring("mode");
irep_idt irept::a_module = dstring("module");
irep_idt irept::a_ordering = dstring("ordering");
irep_idt irept::a_pretty_name = dstring("pretty_name");
irep_idt irept::a_property = dstring("property");

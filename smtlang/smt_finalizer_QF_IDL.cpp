...
Function: smt_finalizer_QF_IDLt::finalize
...
bool smt_finalizer_QF_IDLt::finalize(const exprt& benchmark)
{
  ...
  smt_typecheck_expr_QF_IDLt checker(err, benchmark, empty);
...
void smt_finalizer_QF_IDLt::check_double_sorts(
...
Function: smt_finalizer_QF_IDLt::check_double_functions
...
void smt_finalizer_QF_IDLt::check_double_functions(
  const exprt &benchmark, 
  const symbolst &theories,
...
Function: smt_finalizer_QF_IDLt::check_double_predicates
...
void smt_finalizer_QF_IDLt::check_double_predicates(
  const exprt& benchmark, 
  const symbolst& theories,
  message_streamt &err) 
{
...
Function: smt_typecheck_expr_QF_IDLt::search_fun
...
typet smt_typecheck_expr_QF_IDLt::search_fun(
  const exprt &e,
  const typet &params) 
{  
...
Function: smt_typecheck_expr_QF_IDLt::search_sort
...
typet smt_typecheck_expr_QF_IDLt::search_sort(const typet& sort)
{  

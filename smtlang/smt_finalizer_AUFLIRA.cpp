...
Function: smt_finalizer_AUFLIRAt::finalize
...
bool smt_finalizer_AUFLIRAt::finalize(const exprt& benchmark)
{
  ...
  smt_typecheck_expr_AUFLIRAt checker(err, benchmark, empty);
...
void smt_finalizer_AUFLIRAt::check_double_sorts(
...
Function: smt_finalizer_AUFLIRAt::check_double_functions
...
void smt_finalizer_AUFLIRAt::check_double_functions(
  const exprt &benchmark, 
  const symbolst &theories,
...
Function: smt_finalizer_AUFLIRAt::check_double_predicates
...
void smt_finalizer_AUFLIRAt::check_double_predicates(
  const exprt& benchmark, 
  const symbolst& theories,
  message_streamt &err) 
{
...
Function: smt_typecheck_expr_AUFLIRAt::search_fun
...
typet smt_typecheck_expr_AUFLIRAt::search_fun(
  const exprt &e,
  const typet &params) 
{  
  if (smt_theory_Int_Int_Real_Array_ArraysEx().check_predicates( 
...
Function: smt_typecheck_expr_AUFLIRAt::search_sort
...
typet smt_typecheck_expr_AUFLIRAt::search_sort(const typet& sort)
{  

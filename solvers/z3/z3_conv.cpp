...
smt_ast *
z3_convt::tuple_array_create(const expr2tc &arrayof, const smt_sort *domain)
{
  // Convert an array_of.
  const constant_array_of2t &array = to_constant_array_of2t(arrayof);
  z3::expr value, index;
  z3::sort array_type;
  std::string tmp, identifier;
  int64_t size;

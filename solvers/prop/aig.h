...
{
public:
  typedef enum { AND, VAR, NEXT_VAR } typet;
  typet type;
  literalt a, b;
  ...
  void make_var(unsigned _no)
  {
    type=VAR;
    a=literalt(_no, false);
  }
  
  unsigned var_no() const
  {
    return a.var_no();
  }
};

class aig_variable_labelingt
{
public:
  ...
  virtual ~aig_variable_labelingt()
  {
  }
};
...
public:
  ...
  literalt new_var_node(unsigned var_no)
  {
    literalt l=new_node();
    nodes.back().make_var(var_no);
    return l;
  }
  ...
  virtual void add_variables(propt &dest) const;
  ...
  virtual void print(std::ostream &out, const aig_variable_labelingt &labeling) const;
  virtual void print(std::ostream &out, literalt a, const aig_variable_labelingt &labeling) const;
  virtual void output_dot_node(std::ostream &out, unsigned v, const aig_variable_labelingt &labeling) const;
  virtual void output_dot_edge(std::ostream &out, unsigned v, literalt l) const;
  virtual void output_dot(std::ostream &out, const aig_variable_labelingt &labeling) const;

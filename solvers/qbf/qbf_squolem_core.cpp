...
//  squolem->options().setExtractCoreVariables(true);
//  squolem->options().setSaveCertificate(true);
  squolem->options().setKeepModelFunctions(true);
  squolem->options().setKeepResolutionProof(false);
...
//  squolem->options().setUseExpansion(true);
  ...
  squolem->options().setCompressModel(true);
...
{
  squolem->options().setDebugFileName(str.c_str());
}

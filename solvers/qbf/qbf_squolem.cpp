...
//  squolem.options().setShowStatus(true);
  squolem.options().setFreeOnExit(true);
//  squolem.options().setUseExpansion(true);
//  squolem.options().setPredictOnLiteralBound(true);
  squolem.options().setDebugFileName("debug.qdimacs");
  squolem.options().setSaveDebugFile(true);

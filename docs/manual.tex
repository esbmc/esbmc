...
\url{https://esbmc.github.io/docs/api} and is rebuilt automatically on every
push to \texttt{master}. To build it locally, run \texttt{doxygen .doxygen}
from the top-level directory of ESBMC's source tree (requires
\texttt{doxygen} and \texttt{graphviz}); the HTML lands in
\texttt{docs/html}.

...
`R28FIX ptr=index nil=0 to_global=1` for the array shape that works.
...
```
STRUCT   R28RES in=member renamed=member dest=0
UNION    R28RES in=member renamed=member dest=1
```

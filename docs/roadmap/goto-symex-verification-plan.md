...
copy, taking a 40-test prefix from 28 agreed / 12 non-terminating to 36 / 4 with
no new divergence. It does not touch the constant-propagation gate above, and by

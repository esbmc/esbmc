...
## 102. The `cstd` suite censused — and W4 has a witness
...
### 102.1 The new cause, and why it is W4
...
### 102.2 Why the obvious fix is not available, and what that says about B-4

...
> and §18 (PR #5532, `float.is_integer()`) are in flight and not yet on `master`; this section is
> appended as §19 so the in-flight PRs do not collide on the section number. The maintainer orders
> §16 → §17 → §18 → §19.

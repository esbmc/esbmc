...
void interpretert::execute_function_call()
{
  ...
  if(f_it->second.body_available)
  {
    ...
    // local variables
    goto_programt::local_variablest locals;

    forall_goto_program_instructions(i_it, f_it->second.body)
      locals.insert(i_it->local_variables.begin(),
                    i_it->local_variables.end());
...
void interpretert::build_memory_map()
{
  ...
  for(symbolst::const_iterator it=context.symbols.begin();

...
protected:
  ...
  virtual statet &get_state( void )=0;
  virtual const statet &get_state( void ) const=0;
...
public:
  ...
  inline T& get_data( void ) { return state; }
  inline const T& get_data( void ) const { return state; }

protected:
  T state; // one global state

  virtual statet &get_state( void ) { return state; }

  virtual const statet &get_state( void ) const { return state; }  

...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64)$")
  # No compact clang+llvm-*-aarch64-linux-gnu tarball is published past 19.x,
  # so this is the full install tree: ~1.8GB against ~140MB for the trimmed
  # x86_64 build above, which is a real constraint on a CI runner's disk.
...
if(ESBMC_CHERI AND CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64)$")

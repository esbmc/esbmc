...
if(DOWNLOAD_DEPENDENCIES AND ("${LLVM_DIR}" STREQUAL ""))
  if(ESBMC_CHERI)
    download_zip_and_extract(LLVM ${ESBMC_CHERI_CLANG_URL})
    set(LLVM_DIR ${CMAKE_BINARY_DIR}/LLVM/${ESBMC_CHERI_CLANG_NAME})
    set(Clang_DIR ${CMAKE_BINARY_DIR}/LLVM/${ESBMC_CHERI_CLANG_NAME})  
  else()

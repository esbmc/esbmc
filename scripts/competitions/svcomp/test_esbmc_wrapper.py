...
** Results:
main.c, function bad
  FAILED       [bad.invalid-pointer-freed.1]  line 884  dereference failure: invalid pointer freed
main.c, function main
  NOT CHECKED  [main.memory-leak.1]           line 914  dereference failure: forgotten memory: dynamic_1_array
...
class ParseResultTest(unittest.TestCase):
  ...
  def test_free_offset_is_reachable(self):
    self.assertEqual(
      self.verdict(FREE_NON_ZERO_OFFSET, wrapper.Property.memory), "FALSE_FREE")
